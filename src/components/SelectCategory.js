...
class SelectCategory extends Component {
    ...
    componentWillMount() {
        ...
        {
            this.setState({page    : 'SubCategory'});
        ...
        return (
            <Container>
                ...
                <Header style={styles.header}>
                    <Body>
                    <Title style={[ styles.headerTitle, { paddingHorizontal : 10 } ]}>{I18n.translate('categories')}</Title>
                    </Body>
                    <Right>
                            ...
                            this.state.categories.map((item, key) => (
                                <TouchableOpacity key={key} onPress={()=> {
                                    ...
                                    (item.id == 17 )?
                                        ...
                                        this.props.navigation.navigate(this.state.page,{ category_id : item.id })
                                        :

                                        this.props.navigation.navigate('sub_category',{
                                          category_id : item.id,
