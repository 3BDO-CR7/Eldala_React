...
class Sections extends Component {
    ...
    componentWillMount() {
        ...
        axios.post(`${CONST.url}sections`, { lang: this.state.lang , id : this.props.navigation.state.params.sub_category_id  })
            .then( (response)=> {
...
export default connect(mapStateToProps,{profile})(Sections);
