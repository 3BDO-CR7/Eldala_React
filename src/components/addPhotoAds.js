        ...
        axios.post(`${CONST.url}countries`, { lang: this.state.lang  })
            .then( (response)=> {
                ...
                axios.post(`${CONST.url}cities`, {
                    ...
                    country_id: this.state.countries[0].id
                }).then( (response)=> {
        ...
        if (!err){
            ...
            axios.post(`${CONST.url}uploadPhotoAd`,

                {
                    ...
                    section_id: (this.props.navigation.state.params.section_id) ? this.props.navigation.state.params.section_id : null,
                    type            : '3',
                    images          : base64[0]
                }
        ...
        return (
            <Container>
                ...
                <View style={styles.header}>
                    <View>
                        <Title style={styles.text}>{I18n.translate('add_ads')}</Title>
                    </View>
                    <View>
